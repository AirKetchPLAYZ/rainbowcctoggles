...
@class SBControlCenterController; @class HBForceCepheiPrefs; @class CCUIRoundButton; @class MTMaterialView; 
...
static __attribute__((constructor)) void _logosLocalCtor_a5bfc9e0(int __unused argc, char __unused **argv, char __unused **envp)
{
	timeg = timesl;
}
